...
Public Class Form1
    Private Sub ReadCardBtn_Click(sender As Object, e As EventArgs) Handles ReadCardBtn.Click
        Try
            ...
            Dim myProcess As Process = Process.Start("C:\Users\l\Documents\tempFolder\testbatch.bat")
            ...
            '''''''''''''''''
            ' Connect to database
            Dim dbconn As New DatabaseConnection("C:\Users\l\Documents\tempFolder\CharityDB.accdb")
    ...
    Private Function ReadFile() As String()
        ' Open output file
        Dim FileObj As FileReader = New FileReader("C:\Users\l\Documents\tempFolder\test.txt")
        FileObj.OpenFile()
